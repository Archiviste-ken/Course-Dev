            ...
            <div className="flex h-full flex-col justify-between gap-10">
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <p className="max-w-lg text-sm leading-6 text-white/65 sm:text-base">
                    A minimal, focused login experience with a cool teal accent
                    and the same calm, product-first feel.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3 rounded-2xl border border-white/10 bg-black/20 p-4">
                ...
                <p className="text-sm leading-6 text-white/70">
                  Clear hierarchy, quiet surfaces, and one strong accent color
